...
def test_upsert_source_is_idempotent(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_upsert_item_is_idempotent_and_creates_from_source_edge(
...
def test_upsert_item_with_run_creates_collected_by_edge(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_upsert_item_re_collection_is_last_wins(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_upsert_item_without_run_preserves_existing_collected_by(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_upsert_item_without_run_creates_no_collected_by_edge(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_insert_distilled_creates_record_and_all_edges_atomically(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_insert_distilled_rejects_wrong_dimension_and_reverts_everything(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_insert_distilled_rejects_dim_provenance_mismatch(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_sources_returns_all_with_their_fields(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_create_source_mints_surrogate_id_decoupled_from_canonical(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_create_source_rejects_duplicate_kind_canonical(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_create_source_allows_same_canonical_across_kinds(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_upsert_source_reuses_record_created_by_ui(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_upsert_source_reuses_legacy_sha256_record(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
    ...
    db.query(
        "CREATE $r SET tenant_id = $t, kind = 'rss', canonical = 'https://legacy/feed';",
        {"r": legacy, "t": tenant_id},
    )
...
def test_get_source_returns_full_cadastro(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_get_source_absent_returns_none(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_active_sources_returns_only_enabled_non_archived_of_kind(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_active_sources_carries_canonical_title_tags_for_dispatch(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_active_sources_carries_created_at_as_aware_datetime(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_edit_source_updates_fields_keeping_id_and_history(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_edit_source_blank_title_becomes_none(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_edit_source_rejects_canonical_colliding_with_another(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_edit_source_keeping_own_canonical_is_not_a_duplicate(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_edit_source_same_canonical_across_kinds_is_allowed(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_edit_source_on_archived_is_stale(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_edit_source_absent_is_stale(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_set_source_enabled_pauses_without_archiving(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_set_source_enabled_on_archived_is_stale(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
    ...
    assert _state(db, tenant_id, user_id, rid) == (
        False,
        archived_at_before,
    )  # segue arquivado/desabilitado


def test_set_source_enabled_absent_is_stale(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_archive_source_sets_both_fields_atomically(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_archive_source_already_archived_is_stale(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_archive_source_absent_is_stale(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_restore_source_clears_both_fields_atomically(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_restore_source_not_archived_is_stale(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
    ...
    assert _state(db, tenant_id, user_id, rid) == (
        False,
        None,
    )  # segue pausado, restore não reativou


def test_delete_source_removes_cadastro_with_zero_items(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_delete_source_with_items_is_blocked(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_delete_source_archived_with_zero_items_is_allowed(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_source_item_count_reflects_from_source_edges(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_upsert_source_preserves_owner_edited_title(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_upsert_source_fills_missing_title_from_feed(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_distilled_paginates_without_overlap_or_gap(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_distilled_ordering_is_stable(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
    """A mesma consulta devolve a mesma ordem — paginação estável (ORDER BY determinístico)."""
    _seed_distilled(db, tenant_id, user_id, 4)
    first = [
        d.id
...
def test_list_distilled_empty_acervo_returns_empty(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_distilled_clamps_hostile_bounds(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
    ...
    all_ids = {str(rid) for rid in _seed_distilled(db, tenant_id, user_id, 3)}
...
def test_dashboard_counts_reflects_acervo(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_dashboard_counts_empty_acervo_is_zero(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_recent_runs_newest_first_with_error_kind(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_recent_runs_respects_limit(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
...
def test_item_index_maps_external_id_to_item(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_item_index_collapses_external_id_collision_to_one_entry(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_distilled_for_returns_empty_when_item_has_no_distilled(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_search_returns_the_distilled_for_the_nearest_chunk(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_attach_chunks_creates_chunks_and_makes_distilled_searchable(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_attach_chunks_preserves_existing_provenance(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_attach_chunks_is_noop_when_distilled_already_has_chunks(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_attach_chunks_with_empty_chunks_is_noop(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_attach_chunks_rejects_dim_provenance_mismatch_and_reverts(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_distilled_without_chunks_returns_only_distilled_missing_chunks(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_distilled_without_chunks_excludes_after_attach_chunks(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_distilled_without_chunks_returns_empty_when_no_distilled(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_items_without_distilled_respects_limit(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_items_without_distilled_is_deterministically_ordered(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_items_without_distilled_returns_empty_when_none_pending(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_items_without_distilled_preserves_none_title_and_exact_content(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_items_without_distilled_excludes_empty_and_whitespace_content(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_run_lifecycle_running_then_ok_or_error(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_read_distilled_returns_full_provenance_view(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_read_distilled_without_run_has_empty_runs_but_keeps_items(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_read_distilled_returns_none_for_nonexistent_id(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_read_distilled_handles_missing_optional_fields(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_distilled_card_carries_title_source_and_date(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_entities_counts_mentions_ordered_desc(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_read_entity_returns_mentioning_distilled_cards(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_sources_with_stats_counts_items_and_last_collection(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_runs_paginated_with_error_and_derived_items(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_runs_derives_items_from_distiller_stats(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_runs_derives_repos_total_and_discovered_from_stats(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_runs_repo_counts_are_none_when_absent(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_related_distilled_shares_entity_excludes_self(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_items_by_ids_returns_id_title_content(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_items_by_ids_empty_returns_empty(db: Any, tenant_id: RecordID, user_id: RecordID) -> None:
    """Lista de ids vazia devolve [] sem tocar o banco (não None, não erro)."""
    assert knowledge.items_by_ids(db, []) == []


def test_list_distilled_with_items_carries_summary_item_and_run_worker(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_distilled_with_items_legacy_without_run_has_none_worker(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_list_distilled_with_items_empty_returns_empty(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
...
def test_count_items_without_distilled_matches_the_filter(
    db: Any, tenant_id: RecordID, user_id: RecordID
) -> None:
