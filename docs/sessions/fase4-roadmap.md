...
**Duas falhas silenciosas encontradas no caminho (o mais valioso deste bloco — registrar):**
...
**Tarefa do dono antes da 0021 (substitui a faxina do `/watching`):** estrelar os repos que ele realmente quer no digest — **não migrar os 136**. A lista de watch tem entulho visível (repos de 0 estrela, forks alheios de uma linha) e 136 × até 30 releases na estreia é a enxurrada nomeada no item 4 abaixo. Migrar o acúmulo é copiar o problema; a migração é a chance de fazer a curadoria de verdade.
